...
//const HDWalletProvider = require('@truffle/hdwallet-provider');
const infuraKey = "<INSERT YOUR INFURA-KEY HERE>";

// const fs = require('fs');
// const mnemonic = fs.readFileSync(".secret").toString().trim();
const mnemonic = '<INSERT PRIVATE KEY OF YOUR WALLET HERE>';
...
module.exports = {
  ...
  networks: {
    ...
    tomotestnet: {
      ...
      network_id: "89",
      gas: 6000000,
      gasPrice: 20000000000000, 	// TomoChain requires min 10 TOMO to deploy, to fight spamming attacks
    },
